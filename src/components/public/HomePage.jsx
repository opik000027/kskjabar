    ...
    const HomePage = () => {
      ...
      const heroImages = [
          'https://placehold.co/1920x1080/4a90e2/ffffff?text=Karate+Training+1',
          'https://placehold.co/1920x1080/6a8eab/ffffff?text=Discipline+and+Focus',
          'https://placehold.co/1920x1080/34495e/ffffff?text=Kei+Shin+Kan+Dojo'
      ];
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="p-6">
                    ...
                    <ul className="list-disc list-inside text-gray-700">
                        ${dojo.schedules.map(schedule => `<li>${schedule}</li>`).join('')}
                    </ul>
                </div>
            </div>
        `).join('');
        ...
        <div>
            ...
            <section id="hero-homepage" className="h-screen bg-cover bg-center flex items-center justify-center text-center text-white relative transition-all duration-300">
                ...
                <div className="relative z-20 p-8 max-w-3xl">
                    {/* Logo Kei Shin Kan */}
                    {/* Ganti '/logo-ksk.png' dengan nama file logo Anda yang sebenarnya yang ada di folder 'public' */}
